%--------------------------------------------------------------------------
% detc2017_67668_figure3b.m
% Recreates Figure 3b from DETC2017-67668
%--------------------------------------------------------------------------
%
%--------------------------------------------------------------------------
% Primary contributor: 
...
%% parameters
% taken from Figure 3b of DETC2017-67668
tf = 1;
x0 = 1;
v0 = 2;
b = 0;
...
if ~isempty(Gpks)
    plot([Glocs,Glocs,Glocs],[-1e5,Gpks,1e5],'.--','linewidth',2,...
        'color',[0.3 0.3 0.3],'markersize',20,'MarkerFaceColor',[225,99,97]/255,...
        'MarkerEdgeColor',[225,99,97]/255); hold on
end
...
% save a pdf version
mysavename = 'TP2_2_PSI'; % name to give the saved file
...
% save a pdf version
mysavename = 'TP2_2_X'; % name to give the saved file
pathpdf = mfoldername(mfilename('fullpath'),'pdf');
filename = [pathpdf,mysavename];
str = ['export_fig ''',filename,''' -pdf'];
eval(str)
...
% save a pdf version
mysavename = 'TP2_2_U'; % name to give the saved file
pathpdf = mfoldername(mfilename('fullpath'),'pdf');
filename = [pathpdf,mysavename];
str = ['export_fig ''',filename,''' -pdf'];
eval(str)