%--------------------------------------------------------------------------
% detc2017_67668_figure3c.m
% Recreates Figure 3c from DETC2017-67668
%--------------------------------------------------------------------------
%
%--------------------------------------------------------------------------
% Primary contributor: 
...
%% parameters
% taken from Figure 3c of DETC2017-67668
tf = 2;
x0 = 5;
v0 = -5;
b = 0;
...
if ~isempty(Gpks)
    plot([Glocs,Glocs,Glocs],[-1e5,Gpks,1e5],'.','markersize',20,...
        'MarkerFaceColor',[225,99,97]/255,...
...
% save a pdf version
mysavename = 'TP2_3_PSI'; % name to give the saved file
...
% save a pdf version
mysavename = 'TP2_3_X'; % name to give the saved file
pathpdf = mfoldername(mfilename('fullpath'),'pdf');
filename = [pathpdf,mysavename];
str = ['export_fig ''',filename,''' -pdf'];
eval(str)
...
% save a pdf version
mysavename = 'TP2_3_U'; % name to give the saved file
pathpdf = mfoldername(mfilename('fullpath'),'pdf');
filename = [pathpdf,mysavename];
str = ['export_fig ''',filename,''' -pdf'];
eval(str)